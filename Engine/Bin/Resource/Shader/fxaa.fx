...
float4 FXAAPS(VVSOutput input) : SV_Target
{
    ...
    float4 vFrameOpt = 0.f;
    vFrameOpt.x = -0.5f / 1920.f;
    vFrameOpt.y = -0.5f / 1080.f;
    vFrameOpt.z = 0.5f / 1920.f;
    vFrameOpt.w = 0.5f / 1080.f;

    float4 vFrameOpt2 = 0.f;
    vFrameOpt2.x = -2.f / 1920.f;
    vFrameOpt2.y = -2.f / 1080.f;
    vFrameOpt2.z = 2.f / 1920.f;
    vFrameOpt2.w = 2.f / 1080.f;

    float4 vFrameOpt3 = 0.f;
    vFrameOpt3.x = -4.f * vFrameOpt2.x;
    vFrameOpt3.y = -4.f * vFrameOpt2.y;
    vFrameOpt3.z = -2.f*vFrameOpt2.z;
    vFrameOpt3.w = -2.f*vFrameOpt2.w;

   /*  return FxaaPixelShader(input.tex, 0, t, t, t, rcpro, 
         vFrameOpt, vFrameOpt2, vFrameOpt3, 
         1.0, 0.166, 0.0312, 4.0, 0.125, 0.05, 0);*/
    return g_txProcessed.Sample(g_tLinear, input.tex);
