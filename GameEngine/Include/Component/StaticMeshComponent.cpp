...
{
	m_iSceneComponentClassType = int(SCENECOMPONENT_CLASS_TYPE::SCT_STATICMESH);
}
...
std::shared_ptr<CComponent> CStaticMeshComponent::Clone()
{
	return std::shared_ptr<CComponent>(new CStaticMeshComponent(*this));
}
