...
public:
	...
	void doTests(class dtNavMesh* navmesh, class dtNavMeshQuery* navquery, std::vector<unsigned int>& vecPolys, std::vector<float>& vecStraight, int& _iPoly, int& _iStraight);
	static void TestPath(class dtNavMesh* navmesh, class dtNavMeshQuery* navquery, const Vector3& vStart, const Vector3& vEnd, std::vector<float>& vecStraight, int& _iStraight);
